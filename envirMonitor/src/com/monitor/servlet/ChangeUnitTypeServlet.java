...
public class ChangeUnitTypeServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ChangeUnitTypeServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//获取从页面发回的参数unitTypeID和newUnitTypeName
		String unitTypeID = request.getParameter("unitTypeID");
		String newUnitTypeName = request.getParameter("unitTypeName");
		
		System.out.println("unitTypeID = "+unitTypeID);
		System.out.println("newUnitTypeName = "+newUnitTypeName);
		boolean flag = UnitType_functionDAOImpl.changeUnitType(unitTypeID, newUnitTypeName);
